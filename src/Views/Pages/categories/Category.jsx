      ...
      <div className="container-fluid p-4">
        ...
        <div className="row mb-3">
          <div className="col-md-12  ms-auto mb-3">
            <input
              type="search"
              className="form-control py-3 rounded-3 shadow-sm"
                                  ...
                                  <div className="border rounded-4 p-3 h-100 shadow-sm bg-light">
                                    <div className=" d-flex align-items-center mb-3">
                                      <input
                                        ...
                                        {...register(
                                          `newCategory-${item._id}`,
                                          { required: true }
                                        )}
                                        className={`form-control rounded-start-3 rounded-end-0  border bg-transparent fw-semibold  ${
                                          errors[`newCategory-${item._id}`]
                                            ? "is-invalid"
                                            : ""
                                        }`}
                                      ...
                                      {item.subcategories.map((sub, i) => (
                                        ...
                                        >
                                          <input
                                            ...
                                            className={`form-control  bg-success bg-opacity-25 rounded-5 fw-semibold ${
                                              errors[`sub-${item._id}-${i}`]
                                                ? "is-invalid"
                                                : ""
                                            }`}
                                            style={{
