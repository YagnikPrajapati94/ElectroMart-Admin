...
const ManageCategory = () => {
  ...
  const handleEdit = (id) => {
    navigation(`/admin/categories/addCategory/${id}`);
  };
    ...
    <AdminLayout>
      <div className="container-fluid p-4">
        <div className="row mb-4 px-2 align-items-center">
          <BreadCrumb parent={"Categories"} child={"List"} />
          <div className="col-12 text-center p-0">
            <h3 className="fw-semibold TitleText m-0">Category Directory</h3>
            <small className="SubtitleText">
              View, search, and manage all registered Category names and Images
            </small>
          </div>
        </div>
