    ...
    >
      <div className="row justify-content-between">
        ...
        <div className="col-xl-4 col-lg-8 mx-auto p-0 align-content-center">
          ...
          >
            {/* Heading */}
            <div data-aos="fade" data-aos-delay="200" data-aos-duration="600">
              <img src="/logo/logo.svg" className="" alt="ElectroMart Logo" />
            </div>
            ...
            >
              Access for authorized admin users only
            </p>
            ...
            <p
              ...
              data-aos-duration="600"
            >
              Manage your store, view reports, handle users and keep things
            ...
            >
              Need help?{" "}
              <a href="mailto:support@electromart.com">Contact Support</a>
            </p>
          </form>
        </div>
      </div>
