  ...
  return (
    ...
    >
      <div className="offcanvas-header py-3">
        ...
        <button
          type="button"
          className="btn-close btn-close-white  shadow-none d-lg-none d-block"
          ...
          {menuItems.map((item, index) => (
            <li key={index} className="">
              {item.children ? (
                <>
                  <a
                    className={`d-flex px-4 child-color box-hover  justify-content-between align-items-center text-decoration-none px-2 py-2 ${
                  ...
                  >
                    ...
                    >
                      <i
                        ...
                        style={{
                          color: item.children.some((child) =>
                            isActive(child.path)
                          )
                            ? "rgb(104, 97, 206)"
                            : undefined,
                      ...
                      <li key={subIndex}>
                        <Link
                          ...
                          className={`text-decoration-none   d-block py-1 px-2 rounded ${
                            isActive(sub.path) ? "child-active" : "child-color"
                          }`}
                        >
                          {sub.label}
                        </Link>
                ...
                <Link
                  to={item.path}
                  className={`d-flex box-hover  child-color px-4 align-items-center px-2 py-2 text-decoration-none rounded ${
