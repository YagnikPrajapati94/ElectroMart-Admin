...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg shadow-sm bg-black">
            <div className="container-fluid">
                ...
                >
                    <i className="bi text-light bi-list fs-1"></i>
                </button>

                <div className="ms-auto me-3 py-3">
                    <div className="d-flex align-items-center gap-2 px-3 py-1 bg-light rounded-pill shadow-sm border border-warning">
                ...
                <button
                    ...
                    aria-label="Toggle navigation"
                >
                    <i className="bi text-light bi-three-dots-vertical fs-2"></i>
                </button>


                <div className="collapse navbar-collapse nav-menu mt-lg-0 rounded-3" id="navbarSupportedContent">
                    <ul className="nav d-flex nav-list justify-content-center ms-auto align-items-center">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end shadow rounded-3   border-0 rounded-0 mt-3">
                                ...
                                <li>
                                    <button onClick={handleLogout} className="dropdown-item text-danger btn d-flex align-items-center gap-2">
